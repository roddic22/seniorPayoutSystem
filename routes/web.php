...
Route::middleware('auth')->group(function () {
    ...
    // Seniors: all roles may view; only admin may mutate.
    ...
    // Barangays: admin and clerk may view; only admin may mutate.
    Route::get('barangays', [BarangayController::class, 'index'])
        ->middleware('role:admin,clerk')->name('barangays.index');
    ...
    Route::get('barangays/{barangay}', [BarangayController::class, 'show'])
        ->middleware('role:admin,clerk')->name('barangays.show');

    // Payout cycles: create routes before wildcard routes.
    Route::get('payout-cycles', [PayoutCycleController::class, 'index'])
        ->middleware('role:admin,clerk')->name('payout-cycles.index');
    ...
    Route::get('payout-cycles/{payoutCycle}', [PayoutCycleController::class, 'show'])
        ->middleware('role:admin,clerk')->name('payout-cycles.show');

    // Payout schedules.
    Route::get('payout-schedules', [PayoutScheduleController::class, 'index'])
        ->middleware('role:admin,clerk')->name('payout-schedules.index');
    ...
    Route::get('payout-schedules/{payoutSchedule}', [PayoutScheduleController::class, 'show'])
        ->middleware('role:admin,clerk')->name('payout-schedules.show');

    // Document requirements.
    Route::get('document-requirements', [DocumentRequirementController::class, 'index'])
        ->middleware('role:admin,clerk')->name('document-requirements.index');
    ...
    Route::get('document-requirements/{documentRequirement}', [DocumentRequirementController::class, 'show'])
        ->middleware('role:admin,clerk')->name('document-requirements.show');
    ...
    // Clerk workflow.
    Route::get('payout-transactions', [PayoutTransactionController::class, 'index'])
        ->middleware('role:admin,clerk')->name('payout-transactions.index');
    ...
    Route::get('payout-transactions/{payoutTransaction}', [PayoutTransactionController::class, 'show'])
        ->middleware('role:admin,clerk')->name('payout-transactions.show');

    Route::get('document-submissions', [DocumentSubmissionController::class, 'index'])
        ->middleware('role:admin,clerk')->name('document-submissions.index');
